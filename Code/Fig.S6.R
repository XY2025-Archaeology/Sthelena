...
####################This script is for creating figure S6#######################
...
df<-read_excel("data/FigS6_Data.xlsx")
colnames(df)[9]<-"Sriso"
...
FigS6<-ggarrange(p1,p3,p5,ncol=3,common.legend = F)
 
# Save figure as high-resolution PDF
ggsave("figures/FigS6.pdf", FigS6,width = 18, height = 8,units="cm")
